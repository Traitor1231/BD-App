...
const TerminalInterface: React.FC<TerminalInterfacePropsType> = ({store,isRedirect,FormValidate,PhoneValidateValue,DeleteRubleSymbol,AddRubleSymbol,SumValidateMaxValue,ReturnToMainMenu}) => {
    ...
    <Form action="/" onSubmit={FormValidate}>
      ...
      <InputWrapper>
        ...
        <NavLink to="/">
          <BackButton ref={BackButtonRef} onClick={ReturnToMainMenu}>Назад</BackButton>
        </NavLink>
      </InputWrapper>
    </Form>
  );
